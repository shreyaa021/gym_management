...
<head>
	...
	<style>
     ...
     <body class="page-body  page-fade" onload="collapseSidebar()">
       ...
       <form id="form1" name="form1" method="post" class="a1-container" action="updatepro.php">
         ...
         <tr>
           <td height="35"><table width="100%" border="0" align="center">
             ...
             <tr>
               ...
               <td height="35"><input class="form-control" type="text" name ="password" required> <span class="help-block">*For security reasons hidden</span></td><br>
             </tr>
