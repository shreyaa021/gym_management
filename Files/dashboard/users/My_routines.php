		...
		<table class="table table-bordered datatable" id="table-1" border=1>
				...
				<?php
                 $r= $_SESSION['userid'];
					...
					$query  = "select * from timetable where id='$r'";
					//echo $query;
					...
					if (mysqli_affected_rows($con) != 0) 
					{
					    while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) 
						{
					              ...
					              echo '<td><a href="viewdetailroutine.php?id='.$row['tid'].'"><input type="button" class="a1-btn a1-blue" value="View Details" ></a></td>';
								 ...
								 echo "<td><form action='deleteroutine.php' method='post' onsubmit='return ConfirmDelete()'><input type='hidden' name='name' value='" . $row['tid'] . "'/><input type='submit' value='Delete Routine' width='10px'class='a1-btn a1-orange'/></form></td></tr>";
					                $uid = 0;
