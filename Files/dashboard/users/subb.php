...
$query="insert into users(userid,Full_name,username,gender,mobile,email,dob,joining_date,pass_key) values('$memID','$uname','$uname','$gender','$phn','$email','$dob','$jdate','$password')";
